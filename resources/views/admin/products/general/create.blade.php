                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="slug">الوصف المختصر </label>
                                                            <input type="text" value="{{old('slug')}}" id="slug"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="slug">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="slug">اختر العلامات الدلالية </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select type="" value="{{old('slug')}}" id="slug"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="name"> وصف المتج </label>
                                                            <div id="summernote" type="text" value="{{old('name')}}" id="name"
                                                                 class="form-control"
                                                                 placeholder="  "
                                                                 name="name"></div>
                                                            @error("name")
