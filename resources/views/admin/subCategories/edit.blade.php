                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="parent_id" id="parent_id"
                                                                ...
                                                                @foreach($categories as $category)
                                                                    <option @if($category->id === $subCategory->parent->id) selected @endif value="{{$category->id}}">{{$category->name}}</option>
                                                                @endforeach
                                                            </select>
                                                            @error("name")
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   value="{{old('slug',$subCategory->slug)}}" id="email"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="slug">
                                                            @error("slug")
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($subCategory->status == 'مفعل') checked @endif
                                                            />
